      ...
      <main className="w-full max-w-5xl space-y-10 animate-fade-in">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/dashboard"
              className="rounded-lg border border-black/20 px-3 py-1.5 text-xs font-semibold text-black transition-all duration-150 hover:-translate-y-0.5 hover:border-black/40 hover:bg-white active:scale-95"
            >
              Back to dashboard
            </Link>
          </div>
        ...
        <section className="space-y-6 rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm animate-rise">
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            ...
            <div className="space-y-4 rounded-xl border border-zinc-200 bg-white p-5 text-center">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-black">
                Scoreboard name
              </p>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="relative w-full">
                        <input
                          readOnly
                          value={shareUrl}
                          className="w-full truncate rounded-lg border border-black/20 bg-white px-3 py-2 pr-24 text-sm font-semibold text-black"
                        />
                        <CopyButton
                          value={shareUrl}
                          label="Copy"
                          className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md border border-black/20 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-black transition-all duration-150 hover:-translate-y-0.5 hover:border-black/40 hover:bg-white active:scale-95"
                        />
                      </div>
                      <form action={generateShareToken}>
                        ...
                        <button
                          type="submit"
                          className="inline-flex items-center justify-center rounded-lg border border-black/20 px-3 py-2 text-xs font-semibold text-black transition-all duration-150 hover:-translate-y-0.5 hover:border-black/40 hover:bg-white active:scale-95"
                        >
